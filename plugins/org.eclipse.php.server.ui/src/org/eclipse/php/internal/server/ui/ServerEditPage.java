...
public class ServerEditPage extends WizardPage implements IControlHandler {
	...
	public void createControl(Composite parent) {
		...
		ICompositeFragmentFactory[] factories = ServerTypesManager
				.getInstance().getSettingsFragmentFactories(type);
		...
		getShell().setImage(type.getImage(ImageType.WIZARD));
		...
		setControl(tabs);
		if (type != null) {
			setImageDescriptor(type.getImageDescriptor(ImageType.WIZARD));
		}
	}
