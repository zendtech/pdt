 ...
 * 
 */
public class RenameClassNameWizard extends RenameRefactoringWizard {

	public RenameClassNameWizard(Refactoring refactoring) {
		super(
				refactoring,
				PHPRefactoringUIMessages
						.getString("RenameClassNameWizard_title"), PHPRefactoringUIMessages.getString("RenameGlobalVariableWizard_inputPageDescription"), null, null); //$NON-NLS-1$ //$NON-NLS-2$		
	}
}
