...
/**
 * A TextInputWizardPage is a simple UserInputWizardPage with facilities to
 * create a text input field and validate its contents. The text is assumed to
 * be a java identifier, hence CamelCase word jumping is installed.
 */
